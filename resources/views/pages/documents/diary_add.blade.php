                                        ...
                                        <div class="col-lg-10 push-lg-1">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control" id="comments" rows="2"
                                                          placeholder="(saadud ja antud juhised,ilmastiku-tingimuste ja segavate asjaolude mõju, load, side ametiasutustega jm.)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-10 push-lg-1">
                                            ...
                                            <div class="input-group input-append date" data-date-format="dd-mm-yyyy">
                                                ...
                                                <input id="date" value="{{ date('d.m.Y') }}"
                                ...
                                <fieldset>
                                    <div class="form-group row">
                                        <div class="col-lg-10 push-lg-1">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control" id="control" rows="1"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-10 push-lg-1">
                                            ...
                                            <div class="input-group">
                                                <textarea class="form-control" id="instructions" rows="1"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-lg-10 push-lg-1">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" id="weather_temperature"
                                                               type="number" name="spinner" placeholder="6">
                                                    </div>
                                                </div>
                                            </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('assets/js/pages/documents.diary_add.js')}}"></script>
@stop